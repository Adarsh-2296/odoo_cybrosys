...
import {CartLine} from "../../../../../addons/website_sale/static/src/interactions/cart_line";

export class ClearCart extends Interaction {
    selector = '.o_cart_line';
    dynamicContent = {
...
registry
    ...
    .add('website_sale.cart_line', ClearCart);